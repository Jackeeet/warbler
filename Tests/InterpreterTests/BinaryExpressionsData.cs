    ...
    public static readonly Dictionary<string, Expression> Inputs = new()
    {
        ...
        },
        {
            "intDoubleSubtraction", new BinaryExpression(
                new LiteralExpression(1) { Type = ExpressionType.Double, Line = 1 },
                new Token(TokenKind.Minus, "-", null, 1),
                new LiteralExpression(0.5d) { Type = ExpressionType.Double, Line = 1 }
            ) { Type = ExpressionType.Double, Line = 1 }
        },
        {
        ...
        },
        {
            "intDoubleMultiplication", new BinaryExpression(
                new LiteralExpression(12) { Type = ExpressionType.Double, Line = 1 },
                new Token(TokenKind.Asterisk, "*", null, 1),
                new LiteralExpression(0.5d) { Type = ExpressionType.Double, Line = 1 }
            ) { Type = ExpressionType.Double, Line = 1 }
        },
        ...
        },
        {
            "intDoubleDivision", new BinaryExpression(
                new LiteralExpression(10) { Type = ExpressionType.Double, Line = 1 },
                new Token(TokenKind.Slash, "/", null, 1),
                new LiteralExpression(3d) { Type = ExpressionType.Double, Line = 1 }
            ) { Type = ExpressionType.Double, Line = 1 }
        },
        {
...

        {
            "concatenation", new BinaryExpression(
                new LiteralExpression("warb") { Type = ExpressionType.String, Line = 1 },
                new Token(TokenKind.DoublePlus, "++", null, 1),
                new LiteralExpression("ler") { Type = ExpressionType.String, Line = 1 }
        ...
        },
        {
            "lessEqual", new BinaryExpression(
                ...
                new LiteralExpression("cba") { Type = ExpressionType.String, Line = 1 }
            ) { Type = ExpressionType.Boolean, Line = 1 }
        },
        {
            "intDoubleLessEqual", new BinaryExpression(
                new LiteralExpression(10d) { Type = ExpressionType.Double, Line = 1 },
                new Token(TokenKind.LessEqual, "<=", null, 1),
                new LiteralExpression(20) { Type = ExpressionType.Double, Line = 1 }
            ) { Type = ExpressionType.Boolean, Line = 1 }
        },
        {
        ...
        },
        {
            "intDoubleEqual", new BinaryExpression(
                new LiteralExpression(20) { Type = ExpressionType.Double, Line = 1 },
                new Token(TokenKind.DoubleEqual, "==", null, 1),
                new LiteralExpression(20d) { Type = ExpressionType.Double, Line = 1 }
            ) { Type = ExpressionType.Boolean, Line = 1 }
        },
        {
        ...
        },
        {
            "intDoubleNotEqual", new BinaryExpression(
                new LiteralExpression(20d) { Type = ExpressionType.Double, Line = 1 },
                new Token(TokenKind.NotEqual, "!=", null, 1),
                new LiteralExpression(25) { Type = ExpressionType.Double, Line = 1 }
            ) { Type = ExpressionType.Boolean, Line = 1 }
        },
